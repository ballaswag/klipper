...
ERROR_CODES = {
    1: "%s sensor reported data ready after read. The read process may have"
       " suffered a desync.",
    2: "%s sensor read took too long. The MCU may be overloaded.",
    3: "%s sensor reported a result that is out of its valid range."
}
...
class HX71xBase():
    ...
    def _process_batch(self, eventtime):
        ...
        if error_code != 0:
            logging.error(ERROR_CODES[error_code], (self.name,))
